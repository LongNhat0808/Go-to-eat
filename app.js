  ...
  setTimeout(function() {
    ...
    switch (c) {
      ...
      result_p.innerHTML = "Cơm gà";
          ...
          document.images['Anh'].style.width = '576px';
          document.images['Anh'].style.height = '330px';
      break;
      case '3':
      result_p.innerHTML = "Cơm chiên dương châu";
          ...
          document.images['Anh'].style.width = '600px';
          document.images['Anh'].style.height = '481px';
      break;
      case '4':
      ...
      result_p.innerHTML = "Bánh canh";
          ...
          document.images['Anh'].style.width = '567px';
          document.images['Anh'].style.height = '330px';
      break;
      case '8':
